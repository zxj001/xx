...
public  class GenerateMIMAIgnore$ {
  ...
  private  boolean isDeveloperApi (scala.reflect.runtime.universe sym) { throw new RuntimeException(); }
  private  boolean isExperimental (scala.reflect.runtime.universe sym) { throw new RuntimeException(); }
   ...
   */
  private  scala.collection.mutable.HashSet<java.lang.Class<?>> getClassesFromJar (java.lang.String jarPath, java.lang.String packageName) { throw new RuntimeException(); }
}
