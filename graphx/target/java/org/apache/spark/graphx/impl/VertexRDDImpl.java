...
public  class VertexRDDImpl<VD extends java.lang.Object> extends org.apache.spark.graphx.VertexRDD<VD> {
  ...
  // not preceding
  public   VertexRDDImpl (org.apache.spark.rdd.RDD<org.apache.spark.graphx.impl.ShippableVertexPartition<VD>> partitionsRDD, org.apache.spark.storage.StorageLevel targetStorageLevel, scala.reflect.ClassTag<VD> vdTag) { throw new RuntimeException(); }
  ...
  public <VD2 extends java.lang.Object> org.apache.spark.graphx.VertexRDD<VD2> mapVertexPartitions (scala.Function1<org.apache.spark.graphx.impl.ShippableVertexPartition<VD>, org.apache.spark.graphx.impl.ShippableVertexPartition<VD2>> f, scala.reflect.ClassTag<VD2> evidence$1) { throw new RuntimeException(); }
  ...
  public <VD2 extends java.lang.Object> org.apache.spark.graphx.VertexRDD<VD2> withPartitionsRDD (org.apache.spark.rdd.RDD<org.apache.spark.graphx.impl.ShippableVertexPartition<VD2>> partitionsRDD, scala.reflect.ClassTag<VD2> evidence$13) { throw new RuntimeException(); }
  public  org.apache.spark.graphx.VertexRDD<VD> withTargetStorageLevel (org.apache.spark.storage.StorageLevel targetStorageLevel) { throw new RuntimeException(); }
  public  org.apache.spark.rdd.RDD<scala.Tuple2<java.lang.Object, org.apache.spark.graphx.impl.VertexAttributeBlock<VD>>> shipVertexAttributes (boolean shipSrc, boolean shipDst) { throw new RuntimeException(); }
  public  org.apache.spark.rdd.RDD<scala.Tuple2<java.lang.Object, long[]>> shipVertexIds () { throw new RuntimeException(); }
}
