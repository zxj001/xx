...
public  class DecisionTree$ implements scala.Serializable, org.apache.spark.Logging {
   ...
   */
  public  scala.collection.immutable.List<java.lang.Object> extractMultiClassCategories (int input, int maxFeatureValue) { throw new RuntimeException(); }
  /**
   ...
   */
  public  double[] findSplitsForContinuousFeature (double[] featureSamples, org.apache.spark.mllib.tree.impl.DecisionTreeMetadata metadata, int featureIndex) { throw new RuntimeException(); }
}
