...
public  class Node implements scala.Serializable, org.apache.spark.Logging {
   ...
   */
  public  org.apache.spark.mllib.tree.model.Node deepCopy () { throw new RuntimeException(); }
  /**
   * Get the number of nodes in tree below this node, including leaf nodes.
   * E.g., if this is a leaf, returns 0.  If both children are leaves, returns 2.
   */
  public  int numDescendants () { throw new RuntimeException(); }
  /**
   * Get depth of tree from this node.
   * E.g.: Depth 0 means this is a leaf node.
   */
  public  int subtreeDepth () { throw new RuntimeException(); }
  /**
   * Recursive print function.
   * @param indentFactor  The number of spaces to add to each level of indentation.
   */
  public  java.lang.String subtreeToString (int indentFactor) { throw new RuntimeException(); }
}
