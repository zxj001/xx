...
public  class RowMatrix implements org.apache.spark.mllib.linalg.distributed.DistributedMatrix, org.apache.spark.Logging {
   ...
   */
  public  breeze.linalg.DenseVector<java.lang.Object> multiplyGramianMatrixBy (breeze.linalg.DenseVector<java.lang.Object> v) { throw new RuntimeException(); }
  /**
   ...
   * @return SingularValueDecomposition(U, s, V). U = null if computeU = false.
   */
  public  org.apache.spark.mllib.linalg.SingularValueDecomposition<org.apache.spark.mllib.linalg.distributed.RowMatrix, org.apache.spark.mllib.linalg.Matrix> computeSVD (int k, boolean computeU, double rCond, int maxIter, double tol, java.lang.String mode) { throw new RuntimeException(); }
  /**
   ...
   *         between columns of this matrix.
   */
  public  org.apache.spark.mllib.linalg.distributed.CoordinateMatrix columnSimilaritiesDIMSUM (double[] colMags, double gamma) { throw new RuntimeException(); }
