...
public  class BLAS$ implements scala.Serializable, org.apache.spark.Logging {
   ...
   */
  public  void gemm (boolean transA, boolean transB, double alpha, org.apache.spark.mllib.linalg.Matrix A, org.apache.spark.mllib.linalg.DenseMatrix B, double beta, org.apache.spark.mllib.linalg.DenseMatrix C) { throw new RuntimeException(); }
  /**
   * C := alpha * A * B + beta * C
   * <p>
   * @param alpha a scalar to scale the multiplication A * B.
   ...
   */
  private  void gemm (boolean transA, boolean transB, double alpha, org.apache.spark.mllib.linalg.DenseMatrix A, org.apache.spark.mllib.linalg.DenseMatrix B, double beta, org.apache.spark.mllib.linalg.DenseMatrix C) { throw new RuntimeException(); }
  /**
   * C := alpha * A * B + beta * C
   * For <code>SparseMatrix</code> A.
   */
  private  void gemm (boolean transA, boolean transB, double alpha, org.apache.spark.mllib.linalg.SparseMatrix A, org.apache.spark.mllib.linalg.DenseMatrix B, double beta, org.apache.spark.mllib.linalg.DenseMatrix C) { throw new RuntimeException(); }
  /**
   * y := alpha * A * x + beta * y
   ...
   */
  public  void gemv (boolean trans, double alpha, org.apache.spark.mllib.linalg.Matrix A, org.apache.spark.mllib.linalg.DenseVector x, double beta, org.apache.spark.mllib.linalg.DenseVector y) { throw new RuntimeException(); }
  /**
   * y := alpha * A * x + beta * y
   * <p>
   * @param alpha a scalar to scale the multiplication A * x.
   ...
   * @param y the resulting vector y. Size of m x 1.
   */
  public  void gemv (double alpha, org.apache.spark.mllib.linalg.Matrix A, org.apache.spark.mllib.linalg.DenseVector x, double beta, org.apache.spark.mllib.linalg.DenseVector y) { throw new RuntimeException(); }
  /**
   * y := alpha * A * x + beta * y
   * For <code>DenseMatrix</code> A.
   */
  private  void gemv (boolean trans, double alpha, org.apache.spark.mllib.linalg.DenseMatrix A, org.apache.spark.mllib.linalg.DenseVector x, double beta, org.apache.spark.mllib.linalg.DenseVector y) { throw new RuntimeException(); }
  /**
   * y := alpha * A * x + beta * y
   * For <code>SparseMatrix</code> A.
   */
  private  void gemv (boolean trans, double alpha, org.apache.spark.mllib.linalg.SparseMatrix A, org.apache.spark.mllib.linalg.DenseVector x, double beta, org.apache.spark.mllib.linalg.DenseVector y) { throw new RuntimeException(); }
}
