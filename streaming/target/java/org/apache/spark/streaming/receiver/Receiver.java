...
public abstract class Receiver<T extends java.lang.Object> implements scala.Serializable {
  ...
  public  void setReceiverId (int id_) { throw new RuntimeException(); }
  /** Attach Network Receiver executor to this receiver. */
  public  void attachExecutor (org.apache.spark.streaming.receiver.ReceiverSupervisor exec) { throw new RuntimeException(); }
