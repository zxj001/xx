...
public  class SparkTransportConf$ {
   ...
   */
  private  int MAX_DEFAULT_NETTY_THREADS () { throw new RuntimeException(); }
  /**
   ...
   */
  public  org.apache.spark.network.util.TransportConf fromSparkConf (org.apache.spark.SparkConf _conf, int numUsableCores) { throw new RuntimeException(); }
  /**
   * Returns the default number of threads for both the Netty client and server thread pools.
   * If numUsableCores is 0, we will use Runtime get an approximate number of available cores.
   */
  private  int defaultNumThreads (int numUsableCores) { throw new RuntimeException(); }
}
