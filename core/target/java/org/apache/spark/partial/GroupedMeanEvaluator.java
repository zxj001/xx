 ...
 */
public  class GroupedMeanEvaluator<T extends java.lang.Object> implements org.apache.spark.partial.ApproximateEvaluator<java.util.HashMap<T, org.apache.spark.util.StatCounter>, scala.collection.Map<T, org.apache.spark.partial.BoundedDouble>> {
  // not preceding
  // TypeTree().setOriginal(TypeBoundsTree(TypeTree().setOriginal(Select(Select(Ident(_root_), scala), scala.Nothing)), TypeTree().setOriginal(Select(Select(Ident(_root_), scala), scala.Any))))
  public   GroupedMeanEvaluator (int totalOutputs, double confidence) { throw new RuntimeException(); }
