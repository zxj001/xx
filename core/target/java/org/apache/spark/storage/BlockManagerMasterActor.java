 ...
 */
public  class BlockManagerMasterActor implements akka.actor.Actor, org.apache.spark.util.ActorLogReceive, org.apache.spark.Logging {
  ...
  private  boolean updateBlockInfo (org.apache.spark.storage.BlockManagerId blockManagerId, org.apache.spark.storage.BlockId blockId, org.apache.spark.storage.StorageLevel storageLevel, long memSize, long diskSize, long tachyonSize) { throw new RuntimeException(); }
   ...
   */
  private  scala.Option<scala.Tuple2<java.lang.String, java.lang.Object>> getActorSystemHostPortForExecutor (java.lang.String executorId) { throw new RuntimeException(); }
}
