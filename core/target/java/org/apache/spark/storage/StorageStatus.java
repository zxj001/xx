...
public  class StorageStatus {
  ...
  public  void addBlock (org.apache.spark.storage.BlockId blockId, org.apache.spark.storage.BlockStatus blockStatus) { throw new RuntimeException(); }
  /** Update the given block in this storage status. If it doesn't already exist, add it. */
  public  void updateBlock (org.apache.spark.storage.BlockId blockId, org.apache.spark.storage.BlockStatus blockStatus) { throw new RuntimeException(); }
  /** Remove the given block from this storage status. */
  public  scala.Option<org.apache.spark.storage.BlockStatus> removeBlock (org.apache.spark.storage.BlockId blockId) { throw new RuntimeException(); }
  /**
