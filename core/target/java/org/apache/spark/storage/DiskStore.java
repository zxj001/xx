 ...
 */
public  class DiskStore extends org.apache.spark.storage.BlockStore implements org.apache.spark.Logging {
  // not preceding
  ...
  private  scala.Option<java.nio.ByteBuffer> getBytes (java.io.File file, long offset, long length) { throw new RuntimeException(); }
  public  scala.Option<java.nio.ByteBuffer> getBytes (org.apache.spark.storage.BlockId blockId) { throw new RuntimeException(); }
  public  scala.Option<java.nio.ByteBuffer> getBytes (org.apache.spark.storage.FileSegment segment) { throw new RuntimeException(); }
