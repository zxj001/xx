 ...
 */
public  class BlockManager implements org.apache.spark.network.BlockDataManager, org.apache.spark.Logging {
  ...
  // not preceding
  public   BlockManager (java.lang.String executorId, akka.actor.ActorSystem actorSystem, org.apache.spark.storage.BlockManagerMaster master, org.apache.spark.serializer.Serializer defaultSerializer, long maxMemory, org.apache.spark.SparkConf conf, org.apache.spark.MapOutputTracker mapOutputTracker, org.apache.spark.shuffle.ShuffleManager shuffleManager, org.apache.spark.network.BlockTransferService blockTransferService, org.apache.spark.SecurityManager securityManager, int numUsableCores) { throw new RuntimeException(); }
  ...
  public  org.apache.spark.storage.BlockManagerId shuffleServerId () { throw new RuntimeException(); }
  public  org.apache.spark.network.shuffle.ShuffleClient shuffleClient () { throw new RuntimeException(); }
   ...
   */
  public  void putBlockData (org.apache.spark.storage.BlockId blockId, org.apache.spark.network.buffer.ManagedBuffer data, org.apache.spark.storage.StorageLevel level) { throw new RuntimeException(); }
  /**
