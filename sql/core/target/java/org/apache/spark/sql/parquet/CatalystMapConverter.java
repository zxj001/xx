 ...
 * {@link org.apache.spark.sql.catalyst.types.MapType}.
 * <p>
 * @param schema
 * @param index
 * @param parent
...
public  class CatalystMapConverter extends org.apache.spark.sql.parquet.CatalystConverter {
  ...
  // not preceding
  public   CatalystMapConverter (org.apache.spark.sql.catalyst.types.StructField[] schema, int index, org.apache.spark.sql.parquet.CatalystConverter parent) { throw new RuntimeException(); }
