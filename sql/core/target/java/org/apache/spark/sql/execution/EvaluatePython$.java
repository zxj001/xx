...
public  class EvaluatePython$ implements scala.Serializable {
   ...
   */
  public  Object toJava (Object obj, org.apache.spark.sql.catalyst.types.DataType dataType) { throw new RuntimeException(); }
  /**
   * Convert Row into Java Array (for pickled into Python)
   */
  public  java.lang.Object[] rowToArray (org.apache.spark.sql.catalyst.expressions.Row row, scala.collection.Seq<org.apache.spark.sql.catalyst.types.DataType> fields) { throw new RuntimeException(); }
  public  Object fromJava (Object obj, org.apache.spark.sql.catalyst.types.DataType dataType) { throw new RuntimeException(); }
}
