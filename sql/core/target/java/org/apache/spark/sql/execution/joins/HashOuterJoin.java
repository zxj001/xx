...
public  class HashOuterJoin extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.BinaryNode, scala.Product, scala.Serializable {
  ...
  private  scala.Function1<org.apache.spark.sql.catalyst.expressions.Row, java.lang.Object> boundCondition () { throw new RuntimeException(); }
  private  scala.collection.Iterator<org.apache.spark.sql.catalyst.expressions.Row> leftOuterIterator (org.apache.spark.sql.catalyst.expressions.Row key, org.apache.spark.sql.catalyst.expressions.JoinedRow joinedRow, scala.collection.Iterable<org.apache.spark.sql.catalyst.expressions.Row> rightIter) { throw new RuntimeException(); }
  private  scala.collection.Iterator<org.apache.spark.sql.catalyst.expressions.Row> rightOuterIterator (org.apache.spark.sql.catalyst.expressions.Row key, scala.collection.Iterable<org.apache.spark.sql.catalyst.expressions.Row> leftIter, org.apache.spark.sql.catalyst.expressions.JoinedRow joinedRow) { throw new RuntimeException(); }
  private  scala.collection.Iterator<org.apache.spark.sql.catalyst.expressions.Row> fullOuterIterator (org.apache.spark.sql.catalyst.expressions.Row key, scala.collection.Iterable<org.apache.spark.sql.catalyst.expressions.Row> leftIter, scala.collection.Iterable<org.apache.spark.sql.catalyst.expressions.Row> rightIter, org.apache.spark.sql.catalyst.expressions.JoinedRow joinedRow) { throw new RuntimeException(); }
