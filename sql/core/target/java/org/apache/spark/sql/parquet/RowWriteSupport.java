 ...
 */
public  class RowWriteSupport extends parquet.hadoop.api.WriteSupport<org.apache.spark.sql.catalyst.expressions.Row> implements org.apache.spark.Logging {
  ...
  public  void writeValue (org.apache.spark.sql.catalyst.types.DataType schema, Object value) { throw new RuntimeException(); }
  public  void writePrimitive (org.apache.spark.sql.catalyst.types.PrimitiveType schema, Object value) { throw new RuntimeException(); }
  public  void writeStruct (org.apache.spark.sql.catalyst.types.StructType schema, scala.collection.Seq<java.lang.Object> struct) { throw new RuntimeException(); }
  public  void writeArray (org.apache.spark.sql.catalyst.types.ArrayType schema, scala.collection.Seq<java.lang.Object> array) { throw new RuntimeException(); }
  public  void writeMap (org.apache.spark.sql.catalyst.types.MapType schema, scala.collection.immutable.Map<?, java.lang.Object> map) { throw new RuntimeException(); }
  private  byte[] scratchBytes () { throw new RuntimeException(); }
  public  void writeDecimal (org.apache.spark.sql.catalyst.types.decimal.Decimal decimal, int precision) { throw new RuntimeException(); }
}
