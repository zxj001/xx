...
public abstract class CatalystConverter extends parquet.io.api.GroupConverter {
  ...
  protected  void updateDecimal (int fieldIndex, parquet.io.api.Binary value, org.apache.spark.sql.catalyst.types.DecimalType ctype) { throw new RuntimeException(); }
   ...
   */
  protected  void readDecimal (org.apache.spark.sql.catalyst.types.decimal.Decimal dest, parquet.io.api.Binary value, org.apache.spark.sql.catalyst.types.DecimalType ctype) { throw new RuntimeException(); }
}
