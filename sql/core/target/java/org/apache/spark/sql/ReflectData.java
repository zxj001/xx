...
public  class ReflectData implements scala.Product, scala.Serializable {
  ...
  public  scala.math.BigDecimal decimalField () { throw new RuntimeException(); }
  ...
  // not preceding
  public   ReflectData (java.lang.String stringField, int intField, long longField, float floatField, double doubleField, short shortField, byte byteField, boolean booleanField, scala.math.BigDecimal decimalField, java.sql.Date date, java.sql.Timestamp timestampField, scala.collection.Seq<java.lang.Object> seqInt) { throw new RuntimeException(); }
}
