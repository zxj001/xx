...
public  class ParquetTypesConverter implements org.apache.spark.Logging {
  static public  boolean isPrimitiveType (org.apache.spark.sql.catalyst.types.DataType ctype) { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.types.DataType toPrimitiveDataType (parquet.schema.PrimitiveType parquetType, boolean binaryAsString) { throw new RuntimeException(); }
  /**
   ...
   */
  static public  org.apache.spark.sql.catalyst.types.DataType toDataType (parquet.schema.Type parquetType, boolean isBinaryAsString) { throw new RuntimeException(); }
  /**
   ...
   */
  static public  scala.Option<org.apache.spark.sql.parquet.ParquetTypeInfo> fromPrimitiveDataType (org.apache.spark.sql.catalyst.types.DataType ctype) { throw new RuntimeException(); }
  /**
   ...
   */
  static public  parquet.schema.Type fromDataType (org.apache.spark.sql.catalyst.types.DataType ctype, java.lang.String name, boolean nullable, boolean inArray) { throw new RuntimeException(); }
  static public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> convertToAttributes (parquet.schema.Type parquetSchema, boolean isBinaryAsString) { throw new RuntimeException(); }
  static public  parquet.schema.MessageType convertFromAttributes (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> attributes) { throw new RuntimeException(); }
   ...
   */
  static public  scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> readSchemaFromFile (org.apache.hadoop.fs.Path origPath, scala.Option<org.apache.hadoop.conf.Configuration> conf, boolean isBinaryAsString) { throw new RuntimeException(); }
}
