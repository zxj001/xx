...
public abstract class ByteArrayColumnType<T extends org.apache.spark.sql.catalyst.types.DataType> extends org.apache.spark.sql.columnar.ColumnType<T, byte[]> {
  // not preceding
