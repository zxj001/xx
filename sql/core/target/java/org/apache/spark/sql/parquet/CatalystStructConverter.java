...
public  class CatalystStructConverter extends org.apache.spark.sql.parquet.CatalystGroupConverter {
  ...
  // not preceding
  public   CatalystStructConverter (org.apache.spark.sql.catalyst.types.StructField[] schema, int index, org.apache.spark.sql.parquet.CatalystConverter parent) { throw new RuntimeException(); }
