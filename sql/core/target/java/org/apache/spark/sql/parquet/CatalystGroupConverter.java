...
public  class CatalystGroupConverter extends org.apache.spark.sql.parquet.CatalystConverter {
  ...
  protected  scala.collection.mutable.ArrayBuffer<org.apache.spark.sql.catalyst.expressions.Row> buffer () { throw new RuntimeException(); }
  // not preceding
  public   CatalystGroupConverter (org.apache.spark.sql.catalyst.types.StructField[] schema, int index, org.apache.spark.sql.parquet.CatalystConverter parent, scala.collection.mutable.ArrayBuffer<java.lang.Object> current, scala.collection.mutable.ArrayBuffer<org.apache.spark.sql.catalyst.expressions.Row> buffer) { throw new RuntimeException(); }
  public   CatalystGroupConverter (org.apache.spark.sql.catalyst.types.StructField[] schema, int index, org.apache.spark.sql.parquet.CatalystConverter parent) { throw new RuntimeException(); }
  /**
