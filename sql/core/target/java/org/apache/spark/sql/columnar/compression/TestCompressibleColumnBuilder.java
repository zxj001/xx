...
public  class TestCompressibleColumnBuilder<T extends org.apache.spark.sql.catalyst.types.NativeType> extends org.apache.spark.sql.columnar.NativeColumnBuilder<T> implements org.apache.spark.sql.columnar.NullableColumnBuilder, org.apache.spark.sql.columnar.compression.CompressibleColumnBuilder<T> {
  static public <T extends org.apache.spark.sql.catalyst.types.NativeType> org.apache.spark.sql.columnar.compression.TestCompressibleColumnBuilder<T> apply (org.apache.spark.sql.columnar.ColumnStats columnStats, org.apache.spark.sql.columnar.NativeColumnType<T> columnType, org.apache.spark.sql.columnar.compression.CompressionScheme scheme) { throw new RuntimeException(); }
