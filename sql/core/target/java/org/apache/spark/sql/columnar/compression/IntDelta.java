...
// no position
public  class IntDelta implements org.apache.spark.sql.columnar.compression.CompressionScheme, scala.Product, scala.Serializable {
  static public  class Encoder implements org.apache.spark.sql.columnar.compression.Encoder<org.apache.spark.sql.catalyst.types.IntegerType$> {
  ...
  static public  class Decoder implements org.apache.spark.sql.columnar.compression.Decoder<org.apache.spark.sql.catalyst.types.IntegerType$> {
    public   Decoder (java.nio.ByteBuffer buffer, org.apache.spark.sql.columnar.NativeColumnType<org.apache.spark.sql.catalyst.types.IntegerType$> columnType) { throw new RuntimeException(); }
