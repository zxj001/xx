...
public  class ParquetSchemaSuite extends org.scalatest.FunSuite implements org.apache.spark.sql.parquet.ParquetTest {
   ...
   */
  private <T extends scala.Product> void testSchema (java.lang.String testName, java.lang.String messageType, scala.reflect.ClassTag<T> evidence$1, scala.reflect.api.TypeTags.TypeTag<T> evidence$2) { throw new RuntimeException(); }
}
