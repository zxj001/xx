...
public  class TakeOrdered extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.UnaryNode, scala.Product, scala.Serializable {
  ...
  public  org.apache.spark.sql.catalyst.plans.physical.SinglePartition$ outputPartitioning () { throw new RuntimeException(); }
  public  org.apache.spark.sql.catalyst.expressions.RowOrdering ord () { throw new RuntimeException(); }
