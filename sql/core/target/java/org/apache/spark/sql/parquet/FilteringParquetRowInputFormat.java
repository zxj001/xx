 ...
 */
public  class FilteringParquetRowInputFormat extends parquet.hadoop.ParquetInputFormat<org.apache.spark.sql.catalyst.expressions.Row> implements org.apache.spark.Logging {
  ...
  public  java.util.List<parquet.hadoop.ParquetInputSplit> getClientSideSplits (org.apache.hadoop.conf.Configuration configuration, java.util.List<parquet.hadoop.Footer> footers, java.lang.Long maxSplitSize, java.lang.Long minSplitSize, parquet.hadoop.api.ReadSupport.ReadContext readContext) { throw new RuntimeException(); }
  public  java.util.List<parquet.hadoop.ParquetInputSplit> getTaskSideSplits (org.apache.hadoop.conf.Configuration configuration, java.util.List<parquet.hadoop.Footer> footers, java.lang.Long maxSplitSize, java.lang.Long minSplitSize, parquet.hadoop.api.ReadSupport.ReadContext readContext) { throw new RuntimeException(); }
}
