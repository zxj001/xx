...
// no position
public  class TIMESTAMP extends org.apache.spark.sql.columnar.NativeColumnType<org.apache.spark.sql.catalyst.types.TimestampType$> {
  ...
  static public  java.sql.Timestamp getField (org.apache.spark.sql.catalyst.expressions.Row row, int ordinal) { throw new RuntimeException(); }
