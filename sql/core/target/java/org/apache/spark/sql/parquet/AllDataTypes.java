...
public  class AllDataTypes implements scala.Product, scala.Serializable {
  ...
  // not preceding
  public   AllDataTypes (java.lang.String stringField, int intField, long longField, float floatField, double doubleField, short shortField, byte byteField, boolean booleanField) { throw new RuntimeException(); }
}
