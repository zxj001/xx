...
// no position
public  class STRING extends org.apache.spark.sql.columnar.NativeColumnType<org.apache.spark.sql.catalyst.types.StringType$> {
  static public  int actualSize (org.apache.spark.sql.catalyst.expressions.Row row, int ordinal) { throw new RuntimeException(); }
  ...
  static public  java.lang.String getField (org.apache.spark.sql.catalyst.expressions.Row row, int ordinal) { throw new RuntimeException(); }
