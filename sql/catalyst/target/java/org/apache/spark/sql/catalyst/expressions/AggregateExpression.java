...
public abstract class AggregateExpression extends org.apache.spark.sql.catalyst.expressions.Expression {
   ...
   */
  public  org.apache.spark.sql.catalyst.expressions.AggregateExpression eval (org.apache.spark.sql.catalyst.expressions.Row input) { throw new RuntimeException(); }
}
