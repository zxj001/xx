...
public  class EmptyCatalog implements org.apache.spark.sql.catalyst.analysis.Catalog {
  ...
  static public  boolean tableExists (scala.Option<java.lang.String> db, java.lang.String tableName) { throw new RuntimeException(); }
  static public  scala.runtime.Nothing$ lookupRelation (scala.Option<java.lang.String> databaseName, java.lang.String tableName, scala.Option<java.lang.String> alias) { throw new RuntimeException(); }
