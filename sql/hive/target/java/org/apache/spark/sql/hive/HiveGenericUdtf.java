...
public  class HiveGenericUdtf extends org.apache.spark.sql.catalyst.expressions.Generator implements org.apache.spark.sql.hive.HiveInspectors, scala.Product, scala.Serializable {
  protected  class UDTFCollector implements org.apache.hadoop.hive.ql.udf.generic.Collector {
    ...
    public  scala.collection.mutable.ArrayBuffer<org.apache.spark.sql.catalyst.expressions.Row> collected () { throw new RuntimeException(); }
    public  void collect (java.lang.Object input) { throw new RuntimeException(); }
    public  scala.collection.mutable.ArrayBuffer<org.apache.spark.sql.catalyst.expressions.Row> collectRows () { throw new RuntimeException(); }
  }
  ...
  protected  scala.collection.mutable.Buffer<org.apache.spark.sql.catalyst.types.DataType> outputDataTypes () { throw new RuntimeException(); }
