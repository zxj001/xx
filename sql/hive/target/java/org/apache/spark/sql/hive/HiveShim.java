...
public  class HiveShim {
  ...
  static public  java.lang.String decimalMetastoreString (org.apache.spark.sql.catalyst.types.DecimalType decimalType) { throw new RuntimeException(); }
  static public  org.apache.hadoop.hive.serde2.typeinfo.TypeInfo decimalTypeInfo (org.apache.spark.sql.catalyst.types.DecimalType decimalType) { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.types.DecimalType decimalTypeInfoToCatalyst (org.apache.hadoop.hive.serde2.objectinspector.PrimitiveObjectInspector inspector) { throw new RuntimeException(); }
  static public  org.apache.spark.sql.catalyst.types.decimal.Decimal toCatalystDecimal (org.apache.hadoop.hive.serde2.objectinspector.primitive.HiveDecimalObjectInspector hdoi, Object data) { throw new RuntimeException(); }
}
