...
public  class HiveTableScan extends org.apache.spark.sql.execution.SparkPlan implements org.apache.spark.sql.execution.LeafNode, scala.Product, scala.Serializable {
  ...
  // not preceding
  public   HiveTableScan (scala.collection.Seq<org.apache.spark.sql.catalyst.expressions.Attribute> requestedAttributes, org.apache.spark.sql.hive.MetastoreRelation relation, scala.Option<org.apache.spark.sql.catalyst.expressions.Expression> partitionPruningPred, org.apache.spark.sql.hive.HiveContext context) { throw new RuntimeException(); }
   ...
   */
  public  scala.collection.Seq<org.apache.hadoop.hive.ql.metadata.Partition> prunePartitions (scala.collection.Seq<org.apache.hadoop.hive.ql.metadata.Partition> partitions) { throw new RuntimeException(); }
