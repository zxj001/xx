...
public  class HadoopTableReader$ implements org.apache.spark.sql.hive.HiveInspectors {
   ...
   */
  public  scala.collection.Iterator<org.apache.spark.sql.catalyst.expressions.Row> fillObject (scala.collection.Iterator<org.apache.hadoop.io.Writable> iterator, org.apache.hadoop.hive.serde2.Deserializer deserializer, scala.collection.Seq<scala.Tuple2<org.apache.spark.sql.catalyst.expressions.Attribute, java.lang.Object>> nonPartitionKeyAttrs, org.apache.spark.sql.catalyst.expressions.MutableRow mutableRow) { throw new RuntimeException(); }
}
